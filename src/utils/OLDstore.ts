...
We set our sights on the issue of deforestation, and aimed to create something \ that would increase visibility of it and promote efforts to reduce it. To achieve our goal, we split into two small teams. One team utilized deep learning \
